...
class Bicycle_Manuf(object):
	...
	def __init__(self, manuf_name, manuf_profit)
		self.manuf_name = manuf_name
		self.manuf_profit = manuf_profit
		self.manuf_price = bike_cost + manuf_profit
...
class Bike_Shop(object):
	...
	def __init__(self, bike_shop_name, bike_shop_profit=0.20, bike_shop_inventory=[]):
		...
		self.bike_shop_price = manuf_price + bike_shop_profit

    def add_bike_to_inventory(self, some_bike):
        self.bike_shop_inventory.append(some_bike)

    def remove_bike_from_inventory(self, some_bike):
    	self.bike_shop_inventory.remove(some_bike)
